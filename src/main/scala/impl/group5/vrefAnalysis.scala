    ...
    while(methods.hasNext)
      {
        ...
        else if(sumFieldLoad !=0 || sumFieldStore !=0 || sumLoad !=0 || sumStore !=0) {
        ...
        if(!noMethoden) {
          ...
          else if(localtable.isEmpty && infoZuVariablen && !(sumLoad ==0 && sumStore ==0 && sumFieldLoad ==0 && sumFieldStore ==0))
            {
