...
class NumberOfLoopsAnalysisTest extends FlatSpec with Matchers{
  ...
  "The NumberOfLoopsAnalysis" must "calculate valid results for single JARs" in {
    ...
    //Nur Klassen
    val result3 = AnalysisTestUtils.runSingleFileAnalysis(analysisToTest, fileToTest, appConfig, Map(Symbol("no-methoden") -> true))
    ...
    val result4 = AnalysisTestUtils.runSingleFileAnalysis(analysisToTest, fileToTest, appConfig, Map(Symbol("no-zeroloopclasses") -> true))
    ...
    //Alles ausgeben
    val result5 = AnalysisTestUtils.runSingleFileAnalysis(analysisToTest, fileToTest, appConfig, Map(Symbol("out-all") -> true))
    ...
    val result6 = AnalysisTestUtils.runSingleFileAnalysis(analysisToTest, fileToTest, appConfig, Map(Symbol("no-methoden") -> true, Symbol("no-class") -> true))
