...
class NumberOfChildrenAnalysisTest extends FlatSpec with Matchers{
  ...
  private val result = AnalysisTestUtils.runSingleFileAnalysis(analysisNOC, fileToTest, appConfig, Map.empty[Symbol, Any])
  private val resultNOCMetric = result.head
